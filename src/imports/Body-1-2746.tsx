import svgPaths from "./svg-vzkg11w3vt";
...
function Nav() {
  return (
    <div className="fixed backdrop-blur-[6px] backdrop-filter bg-[rgba(255,255,255,0.95)] box-border content-stretch flex flex-col items-start left-0 px-[152.4px] py-0 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] top-0 w-full z-50" data-name="Nav">
      <Container78 />
    </div>
  );
}
