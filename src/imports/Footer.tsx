import svgPaths from "./svg-p65wea978j";
...
export default function Footer() {
  return (
    <div className="bg-gray-900 relative size-full" data-name="Footer">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start px-[120.4px] py-[64px] relative size-full">
          <Container9 />
        </div>
      </div>
    </div>
