...
export default function SignupPage() {
  ...
  const { signUpWithEmail, updateProfile, signInWithGoogle } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Create/update profile basic info post sign-up
    await updateProfile({ full_name: formData.fullName, phone: formData.phone });
    setPending(false);
